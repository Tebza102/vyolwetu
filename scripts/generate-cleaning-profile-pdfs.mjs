...
const exports = [
  {
    mode: 'digital',
    filename: 'Vyolwetu-Cleaning-Division-Business-Profile-Digital.pdf',
  },
  {
    mode: 'print',
    filename: 'Vyolwetu-Cleaning-Division-Business-Profile-Print.pdf',
  },
]
...
const exportStyles = `
  ...
  .profile-cta-light-outline {
    border-color: rgba(255, 255, 255, 0.72) !important;
    background: rgba(255, 255, 255, 0.06) !important;
    color: #FFFFFF !important;
  }
  .profile-cta-whatsapp {
    background: #00D96F !important;
...
try {
  for (const pdfExport of exports) {
    ...
    await page.goto(`${baseUrl}/cleaning/business-profile`, {
